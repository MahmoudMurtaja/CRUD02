...
namespace CRUD02.Controllers
{
    public class EmployeeTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Id,CreatedAt,isDelete")] EmployeeType employeeType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id,CreatedAt,isDelete")] EmployeeType employeeType)
        {
